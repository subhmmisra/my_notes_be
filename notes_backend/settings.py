...
SECRET_KEY = 'django-insecure-^dm3h1ulx)h-)f30thu#r0)p@q!bj8bdv6*gvtgxnas&yyngv('
...
SITE_SCHEME = os.getenv("SITE_SCHEME", default="http")
SITE_DOMAIN = os.getenv("SITE_DOMAIN", default="localhost:8000")
SITE_NAME = os.getenv("SITE_NAME", default="MyNotes")

SITE_ID = 1

SITES = {
    "1": {"domain": SITE_DOMAIN, "scheme": SITE_SCHEME, "name": SITE_NAME}
}
